...
public class CheckHotels extends JFrame implements Runnable {
   ...
   public void run(){
      String[]  text =new String[]{"JW Marriot Hotel ","Madarindia Orialtal Hotel","Four Season Hotel","Raddison Blue Hotel","Classio Hotel","Breeze Blow Hotel","The Taj Hotel","Happy Morning Hotel","River View Hotel"};
       try{
           for(int i=0;i<=9;i++){
    ...
    CheckHotels(){
        ...
        label[i].setBounds(0,0,800,600);              //  use when setlayout is null
        add(label[i]);
